 ...
 */
final class Version20260216083105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE content_section CHANGE content content LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE content_section CHANGE content content LONGTEXT NOT NULL');
